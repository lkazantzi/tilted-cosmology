...
print("The 1 sigma error of the parameter b is : ",  get_error_estimates123(flatchains_edsa[:, 0], sigma="a"))
print("The 1 sigma error of the parameter Mcal is : ",  get_error_estimates123(flatchains_edsa[:, 1], sigma="a"))
...
fig = c.plotter.plot(figsize=2.0, extents=[[0, 25], [23.75, 23.875]], display=True, truth = [BF_EdSa[0], BF_EdSa[1]])
### check only the distribution
fig = c.plotter.plot_distributions(truth=[BF_EdSa[0], BF_EdSa[1]])
